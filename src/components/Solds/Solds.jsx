...
// function Solds() {
    ...
    // const dayLeft = Math.floor(gap/ 1000 / 60 / 60 / 24);
    // const hrsLeft = Math.floor((gap/ 1000 / 60 / 60 ) % 24);
    // const minLeft = Math.floor((gap/ 1000 / 60 ) % 60);
    // const secLeft = Math.floor((gap/ 1000 ) % 60);
...
//                             </p>
//                             <div className="countdown__timer" id="countdown__timer">
//                                 <div className="timer"><h2 id="day">{timeNow}</h2><p>Дней</p></div>
//                                 <div className="timer"><h2 id="hrs">{gap}</h2><p>Часов</p></div>
//                                 <div className="timer"><h2 id="min">00</h2><p>Минут</p></div>
//                                 <div className="timer"><h2 id="sec">00</h2><p>Секунд</p></div>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
